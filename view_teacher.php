        ...
        <div class="main-body">
            ...
            <section id="main-form">
                ...
                <h2 class="text-center text-white pt-3 font-weight-bold">Student Management System</h2>
                    <h3 class="text-center text-white pb-4 pt-2 font-weight-bold">View Teacher Detail</h3><hr>
                    <div class="row">
                      ...
                      <tbody>
                         <tr>
                             ...
                             <td>
                                 <a href="td_img/<?php echo $row['photo']; ?>">
                                 <img src="td_img/<?php echo $row['photo']; ?>" width="50" height="50"></a>
                             </td>
                             <td>
                                 <a class=" text-center text-white" href="edit_teacher.php?edit_teacher=<?php echo $row['td_id'];?>">Edit</a>|
                                 <a class=" text-center text-white" href="delete_teacher.php?delete_teacher=<?php echo $row['td_id'];?>">Delete</a>
                             </td>
                         </tr> 
                      </tbody>
                        <?php } ?>
