...
if(!$image_type == 'image/jpg' or !$image_type == 'image/png' )
{
    ...
    else
    {
      ...
      $data = "insert into student_detail (fname,lname,father_name,mother_name,email,birth_date,city,mobile_num,nation,district,aadhar,state,gender,photo) values ('$fname','$lname','$fathername','$mothername','$email','$birthdate','$city','$mobilenum','$nationality','$district','$aadharnum','$state','$gender','$image')";
        ...
        <div class="main-body">
            ...
            <p class="text-center text-danger font-weight-bold"><?php echo @$size_error; echo @$type_error;?></p>
                ...
                <h2 class="text-center text-white pt-3 font-weight-bold">Student Management System</h2>
                    <h3 class="text-center text-white pb-4 pt-2 font-weight-bold">Add Student Detail</h3><hr>
                  ...
                  <div class="form-group left">
                      ...
                      <input type="text" name="mothername" placeholder="Enter Your Mother's Name" class="form-control" required="required">
                  </div>
                  <div class="form-group  left">
