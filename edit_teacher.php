...
if(isset($_POST['update']))
{
   ...
   $image_query = "select * from teacher_detail where td_id = '$edit_td_id'";
...
if(!$image_type == 'image/jpg' or !$image_type == 'image/png' )
 {
    ...
    else
    {
      ...
      birth_date = '$birthdate',city = '$city',mobile_num = '$mobilenum',nation = '$nationality',aadhar = '$aadharnum',subject = '$subject',
      gender = '$gender',photo = '$image'
      where td_id = '$edit_td_id'";
      ...
      if($run)
      {
        ...
        echo "<script>window.open('view_teacher.php?update_error = Enable to update data.Please try again!','_self')</script>" ;
      }
    }
}
?>
         ...
         <div class="sidebar-heading">
            <p class="text-center">Manage Student</p>
             ...
             <section id="main-form">
                ...
                <h3 class="text-center text-white pb-4 pt-2 font-weight-bold">Edit Teacher Detail</h3><hr>
                 <?php
                  if(isset($_GET['edit_teacher']))
                  {
                      $edit_td_id=$_GET['edit_teacher'];
                      $query="select * from teacher_detail where td_id = '$edit_td_id'";
                 ...
                 ?> 
                  ...
                  <div class="form-group left">
                      ...
                      <input type="text" name="subject" placeholder="Enter Your Subject" class="form-control" required="required"  value="<?php echo $row['subject'];?>">
                  </div>
